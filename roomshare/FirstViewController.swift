...
class FirstViewController: UIViewController, FUIAuthDelegate {
    ...
    var refCurrentUserName: FIRDatabaseReference!
    ...
    override func viewDidLoad() {
        ...
        refCurrentUserName = FIRDatabase.database().reference(withPath: "rooms/room1/currentUserName")
    ...
    @IBAction func switchClicked(_ sender: Any) {
        ...
        switch roomStatus {
        case .Full: guard user.uid == uidIn else {
                    ...
                    refCurrentUserName.setValue(user.displayName)
        case .Free: refStatus.setValue(RoomStatus.Full.rawValue)
                    refCurrentUser.setValue(user.uid)
                    refCurrentUserName.setValue(user.displayName)
        default: refStatus.setValue(RoomStatus.Unknown.rawValue)
        }
    }
